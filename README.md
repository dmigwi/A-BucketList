...
[![CircleCI](https://circleci.com/gh/andela-dmigwi/A-BucketList.svg?style=svg)](https://circleci.com/gh/andela-dmigwi/A-BucketList)

### [A-BucketList]

Items to be put in a bucket are items that will need to be done by the owner in the near future 

#### [BucketList](http://personalexcellence.co/blog/bucket-list/)
...
This section allows a user to login:
            ...
            **Expected Response**: 
                            - On success: Status Code 201
                            > ```python {"Authorization" : "Bearer <your-token>"}```
                            - On failure: status code 400
                            > ```python {"Error" : "Your password or username is empty or wasn't found"}```
...
This section allows a new user t:
            **Authorization**: ``Bearer <your-token>``
            **Expected Response**: 
